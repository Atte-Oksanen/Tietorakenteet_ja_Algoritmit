...
public class Algorithms {
  ...
  /**
   * This method finds the next prime from the input. Optimized for larger inputs,
   * with a time complexity of O(m/2 * sqrt(n)) where m is the distance to next
   * prime number.
   * NOTE: This method does not work on the values over INT_MAX - 19
   * 
   * @param input
   * @return
   */
